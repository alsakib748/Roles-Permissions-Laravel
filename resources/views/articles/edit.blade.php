                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('articles.update',$article->id) }}" method="POST">
                        ...
                        <div class="">
                            ...
                            <div class="mb-3">
                                <input type="text" name="title" class="border-gray-300 shadow-sm w-1/2 rounded-lg" placeholder="Title" id="title" value="{{ old('title',$article->title) }}" />
                                @error('title')
                            ...
                            <div class="mb-3">
                                <input type="text" name="author" class="border-gray-300 shadow-sm w-1/2 rounded-lg" placeholder="Author" id="author" value="{{ old('author',$article->author) }}" />
                                @error('author')
                                    <p class="text-red-400 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
