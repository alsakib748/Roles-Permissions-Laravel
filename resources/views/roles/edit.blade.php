                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('roles.update',$role->id) }}" method="POST">
                        ...
                        <div class="">
                            ...
                            <div class="mb-3">
                                <input type="text" name="name" class="border-gray-300 shadow-sm w-1/2 rounded-lg" placeholder="Enter Name" id="" value="{{ old('name',$role->name) }}" />
                                @error('name')
                            ...
                            <div class="grid grid-cols-4 mb-3">
                                ...
                                @if($permissions->isNotEmpty())
                                    ...
                                    <div class="mt-3">
                                        <input {{ ($hasPermissions->contains($permission->name)) ? 'checked' : '' }} type="checkbox" class="rounded" name="permission[]" value="{{ $permission->name }}" id="permission-{{ $permission->id }}" />
